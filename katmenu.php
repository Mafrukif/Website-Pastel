                  ...
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <select class="form-select" name="jenismenu" id="">
                        ...
                        <option value="2">Mie/Telur</option>
                      </select>
                      <label for="inputNama">Jenis Menu</label>
                      <div class="invalid-feedback">Masukkan Jenis Menu</div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-floating mb-3">
                      <input type="text" class="form-control" id="inputUsername" placeholder="Kategori Menu"
                        name="katmenu" required>
                      <label for="inputUsername">Kategori Menu</label>
                ...
                <form class="needs-validation" novalidate action="proses/proses_edit_katmenu.php" method="POST">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-floating mb-3">
                        ...
                        required name="jenismenu" id="" >
                          <?php
                          $data = array("Original", "Mie/Telur");
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="input_katmenu_validate"
                      value="<?php echo $row['id_kat_menu'] ?>">Save changes</button>
                  </div>
                </form>
              </div>
            </div>
            ...
            <tbody>
              ...
              foreach ($result as $row) {
                ...
                <tr>
                  ...
                  <td><?php echo ($row['jenis_menu'] == 1) ? "Original" : "Mie/Telur" ?></td>
